...
export default function SideBar(){
    ...
    return(
        <div id="sidebar" className='h-full closed sidebar-container'>
            ...
            <button className='absolute rounded-l-md bg-zinc-300 dark:bg-neutral-900 hover:text-[--active-hex]'
                onClick={()=>{
            ...
            <div className='absolute right-0 h-full rounded-l-md sidebar bg-zinc-300 dark:bg-neutral-900'>
